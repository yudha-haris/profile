...
function Header() {
  ...
  return (
    <header className="bg-slate-100 opacity-95 lg:opacity-90 backdrop-blur-lg shadow-md fixed top-0 left-0 w-full flex items-center z-10">
            ...
            >
              <ul className="block lg:flex items-center">
                ...
                <li className="group">
                  <a
                    href="#home"
                    className="text-lg font-medium text-dark py-4 px-8 flex lg:group-hover:text-primary lg:hover:bg-transparent hover:text-white hover:bg-primary"
                  >
                    Tentang Saya
                  </a>
                </li>
                ...
                <li className="group">
                  <a
                    href="#experience"
                    className="text-lg font-medium text-dark py-4 px-8 flex lg:group-hover:text-primary lg:hover:bg-transparent hover:text-white hover:bg-primary rounded-b-xl"
                  >
                    Pengalaman
                  </a>
                </li>
